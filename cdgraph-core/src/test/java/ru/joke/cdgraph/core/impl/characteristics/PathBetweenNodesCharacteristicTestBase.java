...
abstract class PathBetweenNodesCharacteristicTestBase<T> {
    ...
    @Nonnull
    protected abstract CodeGraphCharacteristic<T> createCharacteristic(@Nonnull PathBetweenNodesCharacteristicParameters parameters);
