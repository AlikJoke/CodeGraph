...
import ru.joke.cdgraph.core.impl.characteristics.factors.StabilityCharacteristic;
...
public class StabilityCharacteristicTest {
    ...
    public void testWhenNodeNotFoundThenException() {
        final var characteristic = new StabilityCharacteristic(new SingleNodeCharacteristicParameters("test"));
