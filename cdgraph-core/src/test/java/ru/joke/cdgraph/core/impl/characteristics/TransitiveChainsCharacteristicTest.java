...
public class TransitiveChainsCharacteristicTest extends SingleNodeCharacteristicTestBase<List<PathBetweenNodes>> {
    ...
    @Nonnull
    @Override
    protected CodeGraphCharacteristic<List<PathBetweenNodes>> createCharacteristic(@Nonnull SingleNodeCharacteristicParameters parameters) {
