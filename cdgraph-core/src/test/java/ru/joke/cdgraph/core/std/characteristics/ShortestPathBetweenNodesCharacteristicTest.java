...
import ru.joke.cdgraph.core.std.characteristics.paths.ShortestPathBetweenNodesCharacteristic;
import ru.joke.cdgraph.core.std.characteristics.paths.ShortestPathBetweenNodesCharacteristicParameters;
import ru.joke.cdgraph.core.std.jms.JavaModuleCodeGraph;

import static org.junit.jupiter.api.Assertions.*;
import static ru.joke.cdgraph.core.std.util.TestUtil.*;
import static ru.joke.cdgraph.core.std.util.TestUtil.TEST_MODULE_3_PATH;
...
public class ShortestPathBetweenNodesCharacteristicTest {
    ...
    public void testWhenTargetAndSourceAreSameThenException() {
        assertThrows(
                ...
                () -> new ShortestPathBetweenNodesCharacteristicParameters(SQL_MODULE, SQL_MODULE)
        );
    }

    @Test
    public void testWhenNoPathExistBetweenNodes() {
        final var params = new ShortestPathBetweenNodesCharacteristicParameters(TEST_MODULE_1, SQL_MODULE);
    ...
    public void testWhenOnlyOnePathExist() {
        final var params = new ShortestPathBetweenNodesCharacteristicParameters(TEST_MODULE_3, TEST_MODULE_1);
        final var characteristic = new ShortestPathBetweenNodesCharacteristic(params);
    ...
    public void testWhenTwoPathsExistThenFoundShortest() {
        final var params = new ShortestPathBetweenNodesCharacteristicParameters(TEST_MODULE_3, SQL_MODULE);
        final var characteristic = new ShortestPathBetweenNodesCharacteristic(params);
    ...
    private void testWhenOneOfNodeNotFound(final String sourceId, final String targetId) {
        final var params = new ShortestPathBetweenNodesCharacteristicParameters(sourceId, targetId);
        final var characteristic = new ShortestPathBetweenNodesCharacteristic(params);
